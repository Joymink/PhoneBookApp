...
from flask_migrate import Migrate #Helps write sql for us
import uuid #distinct string of numbers and idenifier
from datetime import datetime
from werkzeug.security import generate_password_hash, check_password_hash #Encrypt their passwords
